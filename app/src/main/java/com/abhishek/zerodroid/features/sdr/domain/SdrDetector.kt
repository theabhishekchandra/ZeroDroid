...
class SdrDetector(
    ...
    private val knownSdrDevices = KNOWN_DEVICES

    companion object {
        /** USB vendor/product IDs of recognised SDR dongles, with their chipset names. */
        val KNOWN_DEVICES: Map<Pair<Int, Int>, String> = mapOf(
